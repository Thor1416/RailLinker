package com.railweb.shared.domain;
...
public class HashUUIDCreator {
    ...
    public static final UUID NAMESPACE_RAILWEB = new UUID(0x83909664a6094220L, 0xbee060c4c5157db0L);
    ...
    private static UUID getHashUuid(UUID namespace, String name, String algoritm, int version) {
    	...
    	try {
    		...
    		hasher = MessageDigest.getInstance(algoritm);
    		
    		// insert namespace if not null
    		if(namespace != null) {
