 ...
 * be able to use {@link DomainObjectId}s as primary keys. You have to create
 * one subclass per {@link DomainObjectId} subtype.
 *
 * @param <ID> the ID type.
 * @see DomainObjectIdTypeDescriptor
 */
public class DomainObjectIdCustomType<ID extends DomainObjectId<?>> extends AbstractSingleColumnStandardBasicType<ID>
		implements ResultSetIdentifierConsumer {

	/**
	 * 
	 */
	private static final long serialVersionUID = -5491199338414992681L;

	/**
	 * Creates a new {@code DomainObjectIdCustomType}. In your subclass, you should
	 * create a default constructor and invoke this constructor from there.
	 *
