...
import com.railweb.shared.web.SearchOperation;
...
public class GenericSpecificationBuilder<U> {
	...
	public final GenericSpecificationBuilder<U> with(final String key, final String operation, final Object value, final String prefix,
			final String suffix) {
		return with(null, key, operation, value, prefix, suffix);
	}

	public final GenericSpecificationBuilder<U> with(final String precedenceIndicator, final String operation, final String key, final Object value,
			final String prefix, final String suffix) {

		SearchOperation op = SearchOperation.getSimpleOperation(operation.charAt(0));
		if (op != null) {
			if (op == SearchOperation.EQUALITY) { // the operation maybe complex
